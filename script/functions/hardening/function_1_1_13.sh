...
# Function to configure auditing for /etc/sysconfig/docker
harden_sysconfig_docker_auditing() {
    # Path to the sysconfig docker configuration file
    ...
    if [[ -e "$config_file" ]]; then
        ...
        echo "$config_file does not exist. Recommendation does not apply."
